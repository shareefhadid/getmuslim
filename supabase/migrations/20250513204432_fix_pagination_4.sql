CREATE OR REPLACE FUNCTION public.get_nearby_postings_v5(
...
END;
$$;
CREATE OR REPLACE FUNCTION public.get_recent_postings_v5(
...
$$;
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.get_nearby_postings_v5(
    double precision,
    double precision,
    bigint,
    bigint,
  ...
  authenticated,
  service_role;
GRANT EXECUTE ON FUNCTION public.get_recent_postings_v5(
    double precision,
    double precision,
    bigint,
    integer,
