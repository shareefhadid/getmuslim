CREATE OR REPLACE FUNCTION public.get_nearby_postings_v3(
...
END;
$$;
CREATE OR REPLACE FUNCTION public.get_recent_postings_v3(
...
$$;
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.get_nearby_postings_v3(
    double precision,
    double precision,
    bigint,
    bigint,
  ...
  authenticated,
  service_role;
GRANT EXECUTE ON FUNCTION public.get_recent_postings_v3(
    double precision,
    double precision,
    bigint,
    integer,
